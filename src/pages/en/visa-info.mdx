...
export const metadata = {
  ...
  description: "Visa information for the FOSS4G 2024 Conference held in Belém, Brasil on 02-08 December 2024",
}
  ...
  <div className="grid sm:grid-cols-2 space-y-2">
    ...
    <div>
        ...
        **Important:** Before you
        apply for a visa, please double check at the [Official Visa Information](https://www.gov.br/mre/pt-br/assuntos/portal-consular/vistos/quadro-geral-de-regime-de-vistos-para-entrada-de-estrangeiros-no-brasil)

        website to ensure applying for one is necessary. And, begin the
        visa process **at least 6 months in advance**to ensure no issues.

        Here are some helpful links to learn about how to apply for a
        tourist visa:

        - [Find a consular office near you](https://www.gov.br/mre/pt-br/assuntos/portal-consular)
        - [Visa Application Form](https://formulario-mre.serpro.gov.br/sci/pages/web/ui/#/cidadao-nacionalidade)
        - [Immigration Legislation](https://www.gov.br/pt-br/servicos/obter-visto-para-viajar-ao-brasil#etapas-para-a-realizacao-deste-servico)
        - [Brazilian Ministry of Foreign Affairs](https://www.gov.br/mre/pt-br/assuntos/portal-consular/vistos/informacoes-sobre-vistos-para-estrangeiros-viajarem-ao-brasil)
        - [Wikipedia: Visa policy of Brazil](https://en.wikipedia.org/wiki/Visa_policy_of_Brazil)
    </div>
  </div>
</main>
