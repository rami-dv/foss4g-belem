  ...
  <div className="grid md:grid-cols-2 md:space-x-4">
    ...
    <div>
      <div>
        ...
        - **OSGeo Local Chapter of Brazil**, which is dedicated to promoting and disseminating the use of open source geospatial software in the region
        - **Asociación Civil Geolibres Argentina**, a non-profit organization which promotes the adoption of geographic standards and the use of free and open source software
        
        Together they seek the development of geospatial information capabilities through actions that promote and strengthen the geomatics community, and look forward to welcoming participants for a successful FOSS4G event in Belém.
