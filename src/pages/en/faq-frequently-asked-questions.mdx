...
<Grid>
  <Column>
    ...
    <FaqBubble question="What languages are spoken in Belém?">
      ...
      While Brazilians do love international, English-speaking artists, English is not commonly spoken anywhere in the country outside of very specific places and only to a limited capacity.
    </FaqBubble>

    <FaqBubble question="What are the options for transport within Belém?">
      For a comfortable, easy, familiar, and reasonably affordable transport option, we recommend rideshare apps such as Uber, Cabify, or 99, which all function in the city.
  ...
  <Column>
    ...
    <FaqBubble question="How do I get access to Mobile Internet in Belém?">
      ...
      For international visitors, we highly recommend activating international roaming on your phone plan, or if your phone has eSIM capabilities, purchasing a Brazilian eSIM. Belém's international airport has free unlimited WiFi to purchase and activate the eSIM on arrival.
