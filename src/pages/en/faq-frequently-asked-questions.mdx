...
<Grid>
  ...
  <Column>
    ...
    <FaqBubble question="How to get to Belém do Pará?">
      ...
      <IntlLink href="/getting-to-belem">Getting to Belém</IntlLink> page, where
...
<Heading color="red">Accommodation Questions</Heading>
...
<Grid>
  <Column>
    <FaqBubble question="Are food and lodging included in professional and corporate registration fees?">
      ...
      <IntlLink href="/accommodation">Accommodation</IntlLink> page
    </FaqBubble>
...
<Heading color="red">Useful Information</Heading>
...
<Grid>
  <Column>
    ...
    <FaqBubble question="What are the suggested restaurants and pubs in Belem?">
      Some of the best restaurants and pubs in Belém can be found [here](https://www.tripadvisor.com/Restaurants-g303404-zfg11776-Belem_State_of_Para.html), according to TripAdvisor.
    </FaqBubble>
  ...
  <Column>
    <FaqBubble question="How does currency and exchange work in Belém?">
      ...
      credit cards. We leave the official premises to [exchange currency](https://belemtur.belem.pa.gov.br/casas-de-cambio/)
    ...
    <FaqBubble question="Where can I get a SIM card in Belém?">
      ...
      such as [Airalo](https://www.airalo.com/)
    </FaqBubble>
