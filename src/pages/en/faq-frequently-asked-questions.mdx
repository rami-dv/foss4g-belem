...
export const metadata = {
  ...
  description: "Common questions and answers about the FOSS4G 2024 Belém Conference"
};
...
<Grid>
  <Column>
    <FaqBubble question="Where can I find a map of the place and its surroundings?">
      You can find a map of the facilities and surrounding area <Link href="/map">on the "Map" page</Link>
    </FaqBubble>
