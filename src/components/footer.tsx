...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className={`relative z-10 flex w-full max-w-6xl h-full shadow-lg items-center justify-between flex-wrap bg-f4g_red px-2 py-1 sm:px-3 sm:py-3  border-f4g_red border-t border-l border-r sm:rounded-t-xl`}
      >
